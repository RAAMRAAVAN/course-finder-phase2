...
{   
    ...
    let inputDateValue=(event)=>
    {
        if(event.target.value!=="")
            {setDate(event.target.value); console.log("Date from onchange true",Date);   }
        else
            {setDate("");console.log("Date from onchange false",Date);   }            
    }
    ...
    let Filter=()=>
    {
        ...
        console.log("filtered courses",filteredValueTemp);
    }    
